...
namespace StockAnalyzer.Avalonia.ViewModels.Watchlist
{
    ...
    public partial class WatchlistItemViewModel : ObservableObject, IFilterableSymbol
    {
        ...
        public void UpdateStrategyMetadata(decimal? longVal, decimal? exitLong, decimal? stopLossLong, decimal? shortVal, decimal? exitShort, decimal? stopLossShort, string? notes)
        {
            Long = longVal;
            ExitLong = exitLong;
            ...
            if (!string.IsNullOrEmpty(Symbol))
            {
                StockAnalyzer.Core.Services.UserStrategyMetadataRepository.Instance.SaveStrategy(Symbol, longVal, exitLong, stopLossLong, shortVal, exitShort, stopLossShort, notes);
                LoadStrategyMetadata(Symbol);
            }
        }

        public void UpdateStrategyMetadata(decimal? entryPrice, decimal? targetPrice, decimal? stopLoss, string? notes)
        {
            UpdateStrategyMetadata(entryPrice, targetPrice, stopLoss, Short, ExitShort, StopLossShort, notes);
        }
