...
namespace StockAnalyzer.Avalonia.ViewModels.Watchlist
{
    ...
    public partial class WatchlistItemViewModel : ObservableObject
    {
        ...
        private string FormatDateTime(DateTime? val) => val.HasValue ? val.Value.ToString("yyyy-MM-dd HH:mm") : "-";
        ...
        public string DisplayMetadataLastUpdated => FormatDateTime(MetadataLastUpdated);
