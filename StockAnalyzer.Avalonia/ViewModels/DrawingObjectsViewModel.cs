...
public partial class DrawingObjectsViewModel : ViewModelBase, IDisposable
{
    ...
    public DrawingObjectsViewModel(IDispatcherService dispatcherService, IDialogService? dialogService = null, StockAnalyzer.Avalonia.Services.Drawing.IIconDrawingService? iconDrawingService = null)
    {
    ...
    public DrawingObjectsViewModel(ChartViewModel chartViewModel, IDispatcherService dispatcherService, IDialogService? dialogService = null, StockAnalyzer.Avalonia.Services.Drawing.IIconDrawingService? iconDrawingService = null)
        : this(dispatcherService, dialogService, iconDrawingService)
    {
        SetChartViewModel(chartViewModel);
    }

    public DrawingObjectsViewModel(ChartObjectManager objectManager, IDispatcherService dispatcherService, IDialogService? dialogService = null, StockAnalyzer.Avalonia.Services.Drawing.IIconDrawingService? iconDrawingService = null)
        : this(dispatcherService, dialogService, iconDrawingService)
    {
    ...
    public void SyncFromManager()
    {
        ...
        for (int z = models.Count - 1; z >= 0; z--)
        {
            ...
            {
                var newVM = new DrawingObjectItemViewModel(model, manager, () => NotifySelectedProperties(), m => OpenSettingsForModelAsync(m), _iconDrawingService);
