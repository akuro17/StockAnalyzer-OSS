...
/// </summary>
public sealed class NoteScopeSuggestion : ISuggestionRow
{
    ...
    /// DataTemplate binds this, while callers using the concrete type keep binding
    /// <see cref="DisplayName"/> (unchanged name, avoiding an unrelated rename of existing call
    /// sites).</summary>
    string ISuggestionRow.DisplayText => DisplayName;
    ...
    public string IconGeometry => Kind switch
    {
        ...
        NoteScopeSuggestionKind.Ticker => SharedIconGeometries.Ticker,
