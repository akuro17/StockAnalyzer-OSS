...
public partial class MultiSyncProgressViewModel : ViewModelBase
{
    ...
    public MultiSyncProgressViewModel(TickerListViewModel tickerListViewModel)
    {
        ...
        _deleteLatestBarsCount = 0;
        if (_tickerListViewModel != null)
        {
            _tickerListViewModel.DeleteLatestBarsCount = 0;
        }
    ...
    public int DeleteLatestBarsCount
    {
        get => _deleteLatestBarsCount;
        set
        {
            var clamped = Math.Clamp(value, 0, 1000);
            if (SetProperty(ref _deleteLatestBarsCount, clamped))
            {
                if (_tickerListViewModel != null)
                {
                    _tickerListViewModel.DeleteLatestBarsCount = clamped;
                }
            }
        }
    }
