...
public partial class SettingsViewModel : ViewModelBase, IDisposable
{
    ...
    private void NavigateTo(string key)
    {
        ...
        {
            // A cached About page shows the environment as of its last probe; packages may have been installed from another page since.
            if (cachedPage is AboutSettingsViewModel about)
            {
                _ = about.RefreshEnvironmentStatusAsync();
            }
        }
        else
        {
            ...
            cachedPage = key switch
            {
                ...
                SettingsConstants.Keys.Python => _serviceProvider.GetRequiredService<PythonSettingsViewModel>(),
                ...
                SettingsConstants.Keys.ChartDrawing => _serviceProvider.GetRequiredService<DrawingSettingsViewModel>(),
                ...
                SettingsConstants.Keys.ChartDot => _serviceProvider.GetRequiredService<DotSettingsViewModel>(),
                ...
                SettingsConstants.Keys.About => _serviceProvider.GetRequiredService<AboutSettingsViewModel>(),
