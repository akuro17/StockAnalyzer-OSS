...
public partial class ChartGeneralSettingsViewModel : BaseChartSettingsViewModel
{
    ...
    public override bool IsModified
    {
        get
        {
            return CrosshairLabelVisible != Snapshot.CrosshairLabelVisible ||
                   ...
                   EnableExtendedLookbackForIndicators != Snapshot.EnableExtendedLookbackForIndicators;
        }
    }
    ...
    protected override void LoadFromSettings(GlobalChartSettings settings)
    {
        ...
        _enableExtendedLookbackForIndicators = settings.EnableExtendedLookbackForIndicators;
        ...
        OnPropertyChanged(nameof(EnableExtendedLookbackForIndicators));
    ...
    protected override GlobalChartSettings CreateSettings()
    {
        return Snapshot with
        {
            ...
            EnableExtendedLookbackForIndicators = EnableExtendedLookbackForIndicators
        };
    }
}
