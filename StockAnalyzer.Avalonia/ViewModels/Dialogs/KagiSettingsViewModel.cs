...
public partial class KagiSettingsViewModel : BaseChartSettingsViewModel
{
    ...
    protected override void LoadFromSettings(GlobalChartSettings settings)
    {
        ...
        BreakoutBullishColor = HsvData.FromHtmlSafe(settings.KagiMultiWaveBullishColor, HsvData.FromHtmlSafe(ChartSettingsConstants.DefaultBreakoutBullishColor));
        BreakoutBearishColor = HsvData.FromHtmlSafe(settings.KagiMultiWaveBearishColor, HsvData.FromHtmlSafe(ChartSettingsConstants.DefaultBreakoutBearishColor));
        ShowMultiWavePatterns = settings.KagiShowMultiWavePatterns;
        MultiWaveMaxLines = settings.KagiMultiWaveMaxLines;
    ...
    protected override GlobalChartSettings CreateSettings()
    {
        return Snapshot with
        {
            ...
            KagiMultiWaveBullishColor = BreakoutBullishColor.ToHtml(),
            KagiMultiWaveBearishColor = BreakoutBearishColor.ToHtml(),
            KagiShowMultiWavePatterns = ShowMultiWavePatterns,
            KagiMultiWaveMaxLines = Math.Clamp(MultiWaveMaxLines, 1, 20),
    ...
    public override bool IsModified =>
        ...
        MultiWaveMaxLines != Snapshot.KagiMultiWaveMaxLines ||
