...
public partial class PnfSettingsViewModel : BaseChartSettingsViewModel
{
    ...
    protected override void LoadFromSettings(GlobalChartSettings settings)
    {
        ...
        BreakoutBullishColor = HsvData.FromHtmlSafe(settings.PnfBreakoutBullishColor, HsvData.FromHtmlSafe(ChartSettingsConstants.DefaultBreakoutBullishColor));
        BreakoutBearishColor = HsvData.FromHtmlSafe(settings.PnfBreakoutBearishColor, HsvData.FromHtmlSafe(ChartSettingsConstants.DefaultBreakoutBearishColor));
        ...
        MultiWaveMaxLines = settings.PnfMultiWaveMaxLines;
    ...
    protected override GlobalChartSettings CreateSettings()
    {
        return Snapshot with
        {
            ...
            PnfBreakoutBullishColor = BreakoutBullishColor.ToHtml(),
            PnfBreakoutBearishColor = BreakoutBearishColor.ToHtml(),
            ...
            PnfMultiWaveMaxLines = Math.Clamp(MultiWaveMaxLines, 1, 20),
    ...
    public override bool IsModified =>
        ...
        MultiWaveMaxLines != Snapshot.PnfMultiWaveMaxLines ||
