...
public partial class ChartViewModel : ViewModelBase, IChartRenderSettings, IRecipient<TickerSelectedMessage>, IRecipient<TickerDataRefreshedMessage>, IDisposable
{
    ...
    public void Dispose()
    {
        ...
        ObjectManager.Changed -= PersistCurrentDrawings;
    ...
    public void PersistCurrentDrawings()
    {
        ...
        _drawingRepository.Save(_drawingsOwnerSymbol, _drawingsOwnerTimeFrame, snapshot);
    }
    ...
    public void FlushPendingDrawings()
    {
        ...
        try
        {
            _drawingRepository.SaveAsync(_drawingsOwnerSymbol, _drawingsOwnerTimeFrame, snapshot)
        ...
        try
        {
            ...
            if (_drawingRepository != null && _drawingsOwnerSymbol != null)
            {
                ...
                if (ShouldPersistDrawingsSnapshot(outgoingSnapshot))
                {
                    ...
                    // missing file.
                    await _drawingRepository.SaveAsync(_drawingsOwnerSymbol, _drawingsOwnerTimeFrame, outgoingSnapshot);
                }
            }
            ...
            {
                var restoredDrawings = _drawingRepository.Load(Symbol, SelectedTimeFrame);
                if (restoredDrawings != null)
                {
                    ObjectManager.LoadSnapshot(restoredDrawings);
                    if (restoredDrawings.Values.Any(list => list.Count > 0))
                    {
                        _drawingsHasEverBeenNonEmptyForOwner = true;
                    }
                }
