...
public partial class ChartViewModel : ViewModelBase, IChartRenderSettings, IRecipient<TickerSelectedMessage>, IRecipient<TickerDataRefreshedMessage>, IDisposable
{
    ...
    public void PersistCurrentDrawings()
    {
        ...
        var payload = new Services.Drawing.ChartDrawingPayload
        {
            Objects = snapshot,
            Layers = new Dictionary<ChartDrawingContextType, List<DrawingLayerRecord>>(_contextLayersStore)
        };
        _drawingRepository.SavePayload(_drawingsOwnerSymbol, _drawingsOwnerTimeFrame, payload);
    }
    ...
    public void FlushPendingDrawings()
    {
        ...
        try
        {
            _drawingRepository.SavePayloadAsync(_drawingsOwnerSymbol, _drawingsOwnerTimeFrame, payload)
    ...
    private async Task LoadDataInternalAsync(bool forceRefresh)
    {
        ...
        try
        {
            ...
            if (_drawingRepository != null && _drawingsOwnerSymbol != null)
            {
                ...
                if (ShouldPersistDrawingsSnapshot(outgoingSnapshot))
                {
                    _contextLayersStore[_currentContextType] = LayerService.GetAllLayers().ToList();
                    var outgoingPayload = new Services.Drawing.ChartDrawingPayload
                    {
                        Objects = outgoingSnapshot,
                        Layers = new Dictionary<ChartDrawingContextType, List<DrawingLayerRecord>>(_contextLayersStore)
                    };
                    ...
                    // missing file.
                    await _drawingRepository.SavePayloadAsync(_drawingsOwnerSymbol, _drawingsOwnerTimeFrame, outgoingPayload);
                }
            }
            ...
            {
                var restoredPayload = _drawingRepository.LoadPayload(Symbol, SelectedTimeFrame);
