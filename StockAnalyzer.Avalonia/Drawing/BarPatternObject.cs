...
public class BarPatternObject : IChartObject
{
    ...
    public double Thickness { get; set; } = 1.0; // Unused
    ...
    public void Render(SKCanvas canvas, ICoordinateTransform transform)
    {
        ...
        if (IsSelected)
        {
             ...
             using var selPaint = new SKPaint { Color = SKColors.Yellow, Style = SKPaintStyle.Fill };
             canvas.DrawCircle((float)p.X, (float)p.Y, ChartConstants.SelectedHandleRadius, selPaint);
        }
    }
