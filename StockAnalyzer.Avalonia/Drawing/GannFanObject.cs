...
public class GannFanObject : IChartObject
{
    ...
    public void Render(SKCanvas canvas, ICoordinateTransform transform)
    {
        ...
        if (IsSelected)
        {
            SelectionHandleRenderer.Draw(canvas, startScreen, radius: ChartConstants.SelectedHandleRadius);
            SelectionHandleRenderer.Draw(canvas, endScreen, radius: ChartConstants.SelectedHandleRadius);
        }
    }
