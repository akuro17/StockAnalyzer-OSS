...
public static class DrawingThemeContext
{
    ...
    public static float FontSize { get; private set; } = (float)StockAnalyzer.Avalonia.Services.FontDefaults.Detail;
    public static float DetailFontSize => FontSize;
    public static float HelperFontSize { get; private set; } = (float)StockAnalyzer.Avalonia.Services.FontDefaults.Helper;
    public static float BaseFontSize { get; private set; } = (float)StockAnalyzer.Avalonia.Services.FontDefaults.Base;
    ...
    public static float DrawingIconFontSize { get; private set; } = StockAnalyzer.Core.Models.Settings.ChartSettingsConstants.DefaultDrawingIconFontSize;
    ...
    public static StockAnalyzer.Core.Models.DrawingLinkMode DrawingLinkMode { get; private set; } = StockAnalyzer.Core.Models.DrawingLinkMode.SnapToParentAnchorPoint;
    public static StockAnalyzer.Avalonia.Services.Drawing.IIconDrawingService? IconDrawingService { get; set; }

    private static bool _initialized;

    /// <summary>Testability seam: sets the link mode directly, bypassing the once-only Initialize() guard.</summary>
    internal static void SetDrawingLinkModeForTesting(StockAnalyzer.Core.Models.DrawingLinkMode mode) => DrawingLinkMode = mode;
    ...
    {
        if (iconDrawingService != null)
        {
            IconDrawingService = iconDrawingService;
        }
    ...
    private static void UpdateChartDrawingSettings(StockAnalyzer.Core.Services.IChartSettingsManager chartSettingsManager)
    {
        ...
        DrawingIconFontSize = settings.DrawingIconFontSize;
        ...
        DrawingLinkMode = settings.DrawingLinkMode;
    }
}
