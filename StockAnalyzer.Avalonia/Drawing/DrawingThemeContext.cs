...
public static class DrawingThemeContext
{
        ...
        StockAnalyzer.Core.Services.IChartSettingsManager? chartSettingsManager = null)
    {
        ...
        {
            if (e.PropertyName == null || e.PropertyName == nameof(IFontSettingsManager.DetailFontSize))
            {
                UpdateFontSize(fontSettingsManager);
            }
        };
    ...
    private static void UpdateFontSize(IFontSettingsManager fontSettingsManager) => FontSize = (float)fontSettingsManager.DetailFontSize;
