...
public class PitchforkObject : IChartObject
{
    ...
    public void Render(SKCanvas canvas, ICoordinateTransform transform)
    {
        ...
        if (IsSelected)
        {
            SelectionHandleRenderer.Draw(canvas, s1, radius: ChartConstants.SelectedHandleRadius);
            SelectionHandleRenderer.Draw(canvas, s2, radius: ChartConstants.SelectedHandleRadius);
            SelectionHandleRenderer.Draw(canvas, s3, radius: ChartConstants.SelectedHandleRadius);
