...
public interface IChartObject
{
    ...
    /// <summary>
    /// Prevents modification, movement, or deletion when locked.
    /// </summary>
    bool IsLocked { get => false; set { } }
    ...
    /// <summary>
    /// Movement axis constraint mode (XY, X, Y). Default is XY (free 2D movement).
    /// </summary>
    DrawingMoveAxisMode MoveAxisMode { get => DrawingMoveAxisMode.XY; set { } }
