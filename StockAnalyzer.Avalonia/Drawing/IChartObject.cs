...
public interface IChartObject
{
    ...
    /// <summary>
    /// Index of the target sub-window panel this object belongs to.
    /// -1 represents the Main Chart. Values &gt;= 0 represent sub-window indicator panels (0 to K-1).
    /// Default is -1 (Main Chart).
    /// </summary>
    [Category("Coordinates")]
    [DisplayName("Panel Index")]
    [ParameterTag(DrawingParameterTags.Geometry)]
    int PanelIndex { get => -1; set { } }
