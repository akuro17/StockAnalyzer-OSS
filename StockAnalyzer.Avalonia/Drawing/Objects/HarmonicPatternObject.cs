...
/// </summary>
public class HarmonicPatternObject : IChartObject
{
    ...
    {
        // Offload to a dedicated renderer class for cleaner separation
        var renderer = new StockAnalyzer.Avalonia.Drawing.Renderers.HarmonicPatternRenderer();
