...
public class InformationObject : RelativeGeometricRenderer, IDisposable
{
    ...
    /// <summary>
    /// Background opacity (0 to 100%). Default is 10%.
    /// </summary>
    ...
    /// </summary>
    [System.Text.Json.Serialization.JsonIgnore]
    public Rect LastRenderedBounds { get; internal set; }
    ...
    protected override void DrawGeometry(SKCanvas canvas, ICoordinateTransform transform)
    {
        ...
        // Card Background & Border (always drawn in configured Color without selection-color overwrite)
