...
public class AutoElliottWaveObject : IChartObject
{
    ...
    {
        var renderer = new StockAnalyzer.Avalonia.Drawing.Renderers.AutoElliottWaveRenderer();
