...
public class FixedRangeVolumeProfileObject : IChartObject, IDisposable
{
    ...
    public void Render(SKCanvas canvas, ICoordinateTransform transform)
    {
        ...
        if (ProfileData == null || !ProfileData.Any())
        {
            ...
            SelectionHandleRenderer.Draw(canvas, previewP1, radius: ChartConstants.SelectedHandleRadius);
            SelectionHandleRenderer.Draw(canvas, previewP2, radius: ChartConstants.SelectedHandleRadius);
            return;
        }
        ...
        SelectionHandleRenderer.Draw(canvas, p2, radius: ChartConstants.SelectedHandleRadius);
    }
