...
public class GannWheelObject : IChartObject
{
    ...
    public void Render(SKCanvas canvas, ICoordinateTransform transform)
    {
        ...
        if (IsSelected)
        {
            SelectionHandleRenderer.Draw(canvas, center, radius: ChartConstants.SelectedHandleRadius);
            SelectionHandleRenderer.Draw(canvas, radiusP, radius: ChartConstants.SelectedHandleRadius);
        }
    }
