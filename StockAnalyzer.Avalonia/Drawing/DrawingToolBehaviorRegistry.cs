...
public static class DrawingToolBehaviorRegistry
{
    private static readonly Dictionary<DrawingTool, IDrawingToolBehavior> _behaviors = new()
    {
        ...
        [DrawingTool.CatenaryCurve] = new CatenaryCurveBehavior(),
        [DrawingTool.CurveTrend] = new CurveTrendBehavior(),
        [DrawingTool.NurbsTrendCurve] = new NurbsTrendCurveBehavior(),
        [DrawingTool.NurbsParabola] = new NurbsParabolaBehavior(),
        [DrawingTool.NurbsHyperbola] = new NurbsHyperbolaBehavior(),
        [DrawingTool.NurbsConicArc] = new NurbsConicArcBehavior(),

        // --- Shapes ---
        [DrawingTool.Rectangle] = new RectangleBehavior(),
        [DrawingTool.Ellipse] = new EllipseBehavior(),
        [DrawingTool.EllipseAnnulus] = new EllipseAnnulusBehavior(),
        [DrawingTool.Triangle] = new TriangleBehavior(),
        [DrawingTool.NurbsConic] = new NurbsConicBehavior(),
        [DrawingTool.NurbsEllipse] = new NurbsEllipseBehavior(),
        ...
        [DrawingTool.FibonacciEllipse] = new FibEllipseBehavior(),

        // --- Spirals ---
        [DrawingTool.GoldenSpiral] = new GoldenSpiralBehavior(),
        [DrawingTool.LogarithmicSpiral] = new LogarithmicSpiralBehavior(),
        [DrawingTool.ArchimedeanSpiral] = new ArchimedeanSpiralBehavior(),
        ...
        [DrawingTool.CurveChannel] = new CurveChannelBehavior(),
        ...
        [DrawingTool.RangeSpline] = new RangeSplineBehavior(),
        [DrawingTool.FixedRangeVolumeProfile] = new FixedRangeVolumeBehavior(),
        [DrawingTool.TimeAtPrice] = new TimeAtPriceBehavior(),
        [DrawingTool.AnchoredVWAP] = new AnchoredVwapBehavior(),
        [DrawingTool.FftSpectrum] = new FftSpectrumBehavior(),
        ...
        [DrawingTool.LineText] = new LineTextBehavior(),
        [DrawingTool.CurveLineText] = new CurveLineTextBehavior(),
        [DrawingTool.Icon] = new IconBehavior(),
        [DrawingTool.DtwProjection] = new DtwProjectionBehavior(),
        [DrawingTool.KalmanFilterProjection] = new KalmanFilterProjectionBehavior(),
        [DrawingTool.ArimaProjection] = new ArimaProjectionBehavior(),
        [DrawingTool.FftProjection] = new FftProjectionBehavior(),
        [DrawingTool.HmmProjection] = new HmmProjectionBehavior(),
        [DrawingTool.TargetPriceProjection] = new TargetPriceProjectionBehavior(),
        [DrawingTool.PearsonProjection] = new PearsonProjectionBehavior(),
        [DrawingTool.FrechetProjection] = new FrechetProjectionBehavior(),
        [DrawingTool.SsaProjection] = new SsaProjectionBehavior(),
        [DrawingTool.SsaMultiComponent] = new SsaMultiComponentBehavior(),
        [DrawingTool.SsaSupportResistance] = new SsaSupportResistanceBehavior(),
        [DrawingTool.SsaStructuralPivots] = new SsaStructuralPivotsBehavior(),
        [DrawingTool.SsaDynamicEnvelopes] = new SsaDynamicEnvelopesBehavior(),
        [DrawingTool.SsaProjectedTargets] = new SsaProjectedTargetsBehavior(),
        [DrawingTool.SsaAnomalyHighlight] = new SsaAnomalyHighlightBehavior(),
        ...
        [DrawingTool.IchimokuTimeLines] = new IchimokuTimeLinesBehavior(),
        [DrawingTool.SineLine] = new SineLineBehavior(),
        [DrawingTool.TimeCycles] = new TimeCyclesBehavior(),
        [DrawingTool.AutoTimeCycle] = new AutoTimeCycleBehavior(),

        // --- Hough Transform ---
        [DrawingTool.HoughAutoLines] = new HoughAutoLinesBehavior(),
        [DrawingTool.HoughParabolicCurve] = new HoughParabolicCurveBehavior(),
        [DrawingTool.HoughKeyLevels] = new HoughKeyLevelsBehavior(),
        [DrawingTool.HoughResonantFan] = new HoughResonantFanBehavior(),
        [DrawingTool.HoughMagneticLine] = new HoughMagneticLineBehavior(),
        [DrawingTool.Freehand] = new FreehandBehavior(),
    };
