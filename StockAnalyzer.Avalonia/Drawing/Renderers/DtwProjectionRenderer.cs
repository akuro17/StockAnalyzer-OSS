    ...
    public void Render(SKCanvas canvas, IChartObject obj, ICoordinateTransform transform, bool isSelected)
    {
        ...
        })
        {
            ...
            if (isSelected)
            {
                ...
                SelectionHandleRenderer.Draw(canvas, new global::Avalonia.Point(rect.Left, rect.Top), radius: r);
                SelectionHandleRenderer.Draw(canvas, new global::Avalonia.Point(rect.Right, rect.Top), radius: r);
                SelectionHandleRenderer.Draw(canvas, new global::Avalonia.Point(rect.Left, rect.Bottom), radius: r);
                SelectionHandleRenderer.Draw(canvas, new global::Avalonia.Point(rect.Right, rect.Bottom), radius: r);
            }
        }
