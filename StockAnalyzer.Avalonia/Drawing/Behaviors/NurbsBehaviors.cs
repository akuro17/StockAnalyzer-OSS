...
/// <summary>
/// 2-Step interactive click-to-draw behavior for NurbsConicObject.
/// First click places Center, mouse move previews radius, second click finishes placement.
/// </summary>
public sealed class NurbsConicBehavior : TwoClickBehavior<NurbsConicObject>
{
...
/// <summary>
/// 2-Step interactive click-to-draw behavior for NurbsEllipseObject.
/// First click places Center, mouse move previews corner extent (Rx, Ry), second click finishes placement.
/// </summary>
public sealed class NurbsEllipseBehavior : TwoClickBehavior<NurbsEllipseObject>
{
...
/// <summary>
/// 3-Step interactive placement behavior for NurbsConicArcObject.
/// Step 1: Click sets P0 (start), drag updates P1 & P2.
/// Step 2: Click sets P1 (bulge/curvature control), drag updates P2 (end).
/// Step 3: Click fixes P2 and completes tool.
/// </summary>
public sealed class NurbsConicArcBehavior : ThreePointBehavior<NurbsConicArcObject>
{
    protected override NurbsConicArcObject CreateInstance(ChartPoint p, IEnumerable<CoreCandleData>? _)
        => new NurbsConicArcObject(p, p, p);
}
