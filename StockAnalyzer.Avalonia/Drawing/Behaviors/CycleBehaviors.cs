...
public sealed class IchimokuTimeLinesBehavior : ClickToPlaceBehavior<IchimokuTimeLinesObject>
{
    protected override IchimokuTimeLinesObject CreateInstance(ChartPoint p, IEnumerable<CoreCandleData>? _)
        => new IchimokuTimeLinesObject(p);
}
