...
public static class ChartConstants
{
    ...
    /// <summary>
    /// Default normal-direction offset for LineText/CurveLineText top/bottom path-following text (pixels).
    /// </summary>
    public const float DefaultLineTextOffsetPx = 10f;
    ...
    /// <summary>
    /// Triangle Object: Distance from each vertex toward the centroid for interior-angle labels (pixels).
    /// </summary>
    public const float TriangleAngleLabelOffset = 18f;

    /// <summary>
    /// Triangle Object: Dash and gap length for the reflected triangle (pixels).
    /// </summary>
    public const float TriangleReflectionDashInterval = 6f;

    /// <summary>
    /// Triangle Object: Dash and gap length for center construction lines (pixels).
    /// </summary>
    public const float TriangleCenterConstructionDashInterval = 6f;

    /// <summary>
    /// Triangle Object: Radius of centroid/circumcenter/incenter/orthocenter/excenter markers (pixels).
    /// </summary>
    public const float TriangleCenterMarkerRadius = 3f;

    /// <summary>
    /// Triangle Object: Circumcenter bisectors span one radius beyond both sides of the circumcircle.
    /// </summary>
    public const double TriangleCircumBisectorRadiusMultiplier = 2.0;

    /// <summary>
    /// Triangle Object: Minimum absolute doubled screen-space area accepted by center geometry.
    /// </summary>
    public const double TriangleMinimumTwiceArea = 0.001;

    /// <summary>
    /// Triangle Object: Minimum positive denominator accepted by center geometry formulas.
    /// </summary>
    public const double TriangleMinimumCenterDenominator = 0.001;

    /// <summary>
    /// Triangle Object: Minimum squared screen-space edge length accepted by geometry helpers.
    /// </summary>
    public const double TriangleMinimumSquaredEdgeLength = 0.000001;
    ...
    /// <summary>
    /// Pitchfork Object: Radius of the Schiff/Modified Schiff anchor highlight ring (pixels).
    /// </summary>
    public const float PitchforkAnchorHighlightRadius = 4f;

    /// <summary>
    /// Pitchfork Object: Stroke width of the Schiff/Modified Schiff anchor highlight ring (pixels).
    /// </summary>
    public const float PitchforkAnchorHighlightStrokeWidth = 2f;
    ...
    /// <summary>
    /// Long/Short Position Object: Minimum visual width of the position box (pixels),
    /// enforced when the user resizes it by dragging the Stop/Target handle.
    /// </summary>
    public const float LongShortMinBoxWidth = 20f;

    /// <summary>
    /// Long/Short Position Object: Minimum price separation enforced between Entry/Stop/Target
    /// when clamping drag values to prevent them from crossing/inverting.
    /// </summary>
    public const decimal LongShortPriceClampEpsilon = 0.0001m;
    ...
    /// <summary>
    /// Long/Short Position tool: initial Stop/Target offset from Entry as a fraction of Entry
    /// price, applied symmetrically (+/-) when the tool is first placed. Large enough that the
    /// box is comfortably draggable immediately after placement.
    /// </summary>
    public const decimal LongShortInitialOffsetPercent = 0.10m;
    ...
    /// <summary>
    /// Screen-space distance (pixels, per axis) within which a pointer click is
    /// considered to have hit a drawing object's selection handle, for starting a
    /// handle drag/resize operation. Used by ChartInteractionController.
    /// </summary>
    public const double HandleClickToleranceScreenPx = 10.0;
    ...
    public const int IndicatorCalculationDebounceDelay = 150;
