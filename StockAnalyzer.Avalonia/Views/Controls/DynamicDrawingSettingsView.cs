...
/// <summary>
/// A control that dynamically generates settings UI for a given chart drawing object (ParameterObject).
/// Uses DrawingParameterViewBuilder to create controls based on attributes.
/// </summary>
public class DynamicDrawingSettingsView : UserControl
{
    public static readonly StyledProperty<object?> ParameterObjectProperty =
        AvaloniaProperty.Register<DynamicDrawingSettingsView, object?>(nameof(ParameterObject));
    ...
    public static readonly StyledProperty<IReadOnlyCollection<string>?> HiddenParameterTagsProperty =
        AvaloniaProperty.Register<DynamicDrawingSettingsView, IReadOnlyCollection<string>?>(nameof(HiddenParameterTags));
    ...
    private readonly DrawingParameterViewBuilder _builder = new();
