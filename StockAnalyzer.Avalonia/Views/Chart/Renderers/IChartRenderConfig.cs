...
/// <summary>Dot chart rendering configuration.</summary>
public interface IDotChartRenderConfig : IChartRenderConfig
{
    IndicatorColor DotUpColor { get; }
    IndicatorColor DotDownColor { get; }
    IndicatorColor DotNaturalColor { get; }
    double DotBaseRadius { get; }
    DotShapeType DotShape { get; }
    PriceType DotPriceType { get; }
}
