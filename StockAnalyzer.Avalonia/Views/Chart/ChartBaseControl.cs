...
public class ChartBaseControl : Control, ICustomHitTest
{
    ...
    private readonly FreehandPointerAdapter _freehandAdapter = new();
    ...
    private void UpdateLayeredScene()
    {
        ...
        _layeredScene.UpdateScene(
            ...
            panelKey =>
            {
                if (panelKey.Kind == StockAnalyzer.Core.Models.Drawing.PanelKind.Main) return true;
                return DrawingPanelResolver.TryGetPanelIndex(panelKey, ViewModel.Indicators, ViewModel.IsSubWindowVisible).HasValue;
            });
