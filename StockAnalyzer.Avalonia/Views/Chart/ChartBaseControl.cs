...
public class ChartBaseControl : Control, ICustomHitTest
{
    ...
    protected override void OnPointerMoved(PointerEventArgs e)
    {
        ...
        bool interactionHandled = _interactionController.HandlePointerMoved(
            position,
            chartPosition,
            ViewModel,
            _dataCoordinator.Transform,
    ...
    private void OnDoubleTappedHandler(object? sender, TappedEventArgs e)
    {
        ...
        _interactionController.HandleDoubleTap(pos, chartPosition, ViewModel, _dataCoordinator.Transform, _currentSnapshot, e.KeyModifiers);
