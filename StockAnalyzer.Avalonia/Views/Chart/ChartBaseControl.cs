...
public class ChartBaseControl : Control, ICustomHitTest
{
    ...
    protected override void OnSizeChanged(SizeChangedEventArgs e)
    {
        ...
        {
            System.IO.File.WriteAllText(@"Y:\Temp\sa_crash.txt", $"OnSizeChanged Error: {ex}");
            throw; // Re-throw to ensure we don't hide it, but we captured it!
        }
    }
    ...
    protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        {
            System.IO.File.WriteAllText(@"Y:\Temp\sa_crash.txt", $"OnAttached Error: {ex}");
            throw;
        }
    }
