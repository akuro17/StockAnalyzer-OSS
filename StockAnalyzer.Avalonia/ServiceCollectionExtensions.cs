...
public static class ServiceCollectionExtensions
{
    ...
    public static void AddViewModels(this IServiceCollection services)
    {
        ...
        services.AddSingleton<DrawingObjectsViewModel>();
        ...
        services.AddSingleton<StockAnalyzer.Avalonia.ViewModels.Notes.NoteTimelineViewModel>();
    ...
    private static void AddWorkspaceTabs(this IServiceCollection services)
    {
        ...
        services.AddSingleton<ITabRegistry>(sp =>
        {
            ...
            registry.Register(new Core.Models.UI.TabMetadata("NoteTimeline", localizer.GetString("Tab_Notes")),
