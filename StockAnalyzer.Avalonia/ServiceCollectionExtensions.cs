...
public static class ServiceCollectionExtensions
{
    public static void AddCommonServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.Configure<StockAnalyzer.Core.Models.Settings.BacktestSettings>(configuration.GetSection("Backtest"));
        services.Configure<StockAnalyzer.Core.Models.Settings.PythonIpcSettings>(configuration.GetSection("PythonIpc"));
        services.Configure<StockAnalyzer.Core.Models.Settings.DrawingInteractionSettings>(configuration.GetSection("DrawingInteraction"));
        ...
        services.AddSingleton<IPythonSettingsManager, PythonSettingsManager>();
        services.AddSingleton<IPredictionSettingsManager, PredictionSettingsManager>();
        ...
        services.AddSingleton<Core.Interfaces.ISourceIndicatorService, Core.Services.SourceIndicatorService>();
        services.AddSingleton<Core.Interfaces.IDynamicPeriodDriverService, Core.Services.DynamicPeriodDriverService>();
        services.AddSingleton<Services.Drawing.ChartDrawingRepository>();
        services.AddSingleton<Services.Drawing.IChartDrawingRepository>(sp => sp.GetRequiredService<Services.Drawing.ChartDrawingRepository>());
        services.AddSingleton<Services.Drawing.IDrawingDocumentRepository, Services.Drawing.DrawingDocumentRepository>();
        services.AddSingleton<Services.Drawing.DrawingDocumentSessionStore>();
        services.AddSingleton<Services.Drawing.IIconDrawingService, Services.Drawing.IconDrawingService>();
        services.AddTransient<Services.Drawing.IDrawingLayerService, Services.Drawing.DrawingLayerService>();
        ...
        services.AddSingleton<Services.IExternalFileOpener, Services.ExternalFileOpener>();
        ...
        services.AddSingleton<Services.Export.ILayeredChartImageExportService, Services.Export.ChartImageExportService>();
        ...
        services.AddTransient<Services.VolumeProfileViewportCoordinator>();
        services.AddTransient<Services.TimeAtPriceViewportCoordinator>();
        ...
        services.AddSingleton<IDrawingSettingsPanelRegistry>(sp =>
        {
            ...
            registry.Register(new TimeAtPriceSettingsPanelDefinition());
            ...
            registry.Register(new ArimaProjectionSettingsPanelDefinition());
            ...
            registry.Register(new SsaMultiComponentSettingsPanelDefinition());
            registry.Register(new SsaStructuralPivotsSettingsPanelDefinition());
            registry.Register(new SsaDynamicEnvelopesSettingsPanelDefinition());
            registry.Register(new SsaProjectedTargetsSettingsPanelDefinition());
            registry.Register(new SsaSupportResistanceSettingsPanelDefinition());
            registry.Register(new SsaAnomalyHighlightSettingsPanelDefinition());
            registry.Register(new CatenaryCurveSettingsPanelDefinition());
            registry.Register(new HoughAutoLinesSettingsPanelDefinition());
            registry.Register(new HoughParabolicCurveSettingsPanelDefinition());
            registry.Register(new HoughKeyLevelsSettingsPanelDefinition());
            registry.Register(new HoughResonantFanSettingsPanelDefinition());
            registry.Register(new HoughMagneticLineSettingsPanelDefinition());
            registry.Register(new AutoTimeCycleSettingsPanelDefinition());
            registry.Register(new InformationSettingsPanelDefinition());
            registry.Register(new IconSettingsPanelDefinition());
            registry.Register(new SpiralSettingsPanelDefinition());
            registry.Register(new FibonacciRetracementSettingsPanelDefinition());
            registry.Register(new CyclicLinesSettingsPanelDefinition());
            registry.Register(new IchimokuTimeLinesSettingsPanelDefinition());
            return registry;
        });
        ...
        services.AddSingleton<Core.Services.IPythonEnvironmentInspector, Core.Services.PythonEnvironmentInspector>(); // About page environment probe (read-only, never triggers setup)
        ...
        services.AddSingleton<Core.Services.Screener.IScreenerTemplateEvaluator, Core.Services.Screener.ScreenerTemplateEvaluator>();
        ...
        services.AddSingleton<ISpiralAnalysisDataSource, SpiralAnalysisDataSource>();
        services.AddSingleton<ISeasonalityChartDataSource, SeasonalityChartDataSource>();
        services.AddTransient<SeasonalityChartViewModel>();
        ...
        // Backtest (P3)
        services.AddSingleton<Core.Services.Backtest.Engine.IBacktestEngine, Core.Services.Backtest.Engine.BacktestEngine>();
        services.AddSingleton<Core.Services.Backtest.Engine.StrictEvidence.IStrictBacktestEngine,
            Core.Services.Backtest.Engine.StrictEvidence.StrictBacktestEngine>();
        // Owner decision G3: the additive diagnostic entry point resolves to the SAME engine instance (never a second registration of BacktestEngine).
        services.AddSingleton<Core.Services.Backtest.Engine.IBacktestDiagnosticEngine>(
            sp => (Core.Services.Backtest.Engine.IBacktestDiagnosticEngine)sp.GetRequiredService<Core.Services.Backtest.Engine.IBacktestEngine>());
        services.AddSingleton<Core.Services.Backtest.Reporting.BacktestReportGenerator>();
        services.AddSingleton<Core.Services.Backtest.Reporting.IBacktestReportGenerator>(
            sp => sp.GetRequiredService<Core.Services.Backtest.Reporting.BacktestReportGenerator>());
        services.AddSingleton<Core.Services.Backtest.Reporting.ICancellableBacktestReportGenerator>(
            sp => sp.GetRequiredService<Core.Services.Backtest.Reporting.BacktestReportGenerator>());
        services.AddSingleton<Core.Services.Backtest.Reporting.IQualifiedBacktestReportGenerator>(
            sp => sp.GetRequiredService<Core.Services.Backtest.Reporting.BacktestReportGenerator>());
        services.AddSingleton<Core.Services.Backtest.Evaluation.ISamplingEvidenceTrustPolicy,
            Core.Services.Backtest.Evaluation.NoSamplingEvidenceTrustPolicy>();
        services.AddSingleton<Core.Services.Backtest.Evaluation.IBacktestEvaluationService,
            Core.Services.Backtest.Evaluation.BacktestEvaluationService>();
        services.AddSingleton<Core.Services.Backtest.Reporting.IBacktestReportSettingsManager, Core.Services.Backtest.Reporting.BacktestReportSettingsManager>();
        services.AddSingleton<Core.Services.Backtest.Reporting.IBacktestReportExporter, Core.Services.Backtest.Reporting.BacktestReportExporter>();
        services.AddSingleton<Core.Services.Backtest.Configuration.IBacktestConfigurationManager, Core.Services.Backtest.Configuration.BacktestConfigurationManager>();
        services.AddSingleton<Core.Services.Backtest.Configuration.IBacktestDefaultSettingsManager, Core.Services.Backtest.Configuration.BacktestDefaultSettingsManager>();
        services.AddSingleton<Services.IBacktestRunPreparationService, Services.BacktestRunPreparationService>();
        services.AddSingleton<Services.IBacktestSettingsCoordinator, Services.BacktestSettingsCoordinator>();
        services.AddTransient<ViewModels.Backtest.BacktestIndicatorSelectionViewModel>();
        services.AddTransient<ViewModels.Backtest.BacktestResultsViewModel>();
        services.AddTransient<ViewModels.Backtest.BacktestWindowViewModel>();
    ...
    public static void AddViewModels(this IServiceCollection services)
    {
        ...
        services.AddTransient<StockAnalyzer.Avalonia.ViewModels.Dialogs.PythonSettingsViewModel>();
        ...
        services.AddTransient<StockAnalyzer.Avalonia.ViewModels.Dialogs.TrainingWizardViewModel>();
        ...
        services.AddTransient<StockAnalyzer.Avalonia.ViewModels.Dialogs.DotSettingsViewModel>();
        ...
        services.AddTransient<StockAnalyzer.Avalonia.ViewModels.Dialogs.SeasonalitySettingsViewModel>();
    ...
    private static void AddWorkspaceTabs(this IServiceCollection services)
    {
        ...
        services.AddSingleton<ITabRegistry>(sp =>
        {
            ...
            registry.Register(new Core.Models.UI.TabMetadata("SeasonalityChart", localizer.GetString("Tab_SeasonalityChart"), AllowMultiple: true),
                s => s.GetRequiredService<SeasonalityChartViewModel>());
