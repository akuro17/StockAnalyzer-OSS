    ...
    public static void Main(string[] args)
    {
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            .WriteTo.Async(a => a.File(
                ...
                path: System.IO.Path.Combine(logDirectory, "stockanalyzer-json-.log"),
                rollingInterval: RollingInterval.Day,
                retainedFileCountLimit: 30))
            .WriteTo.Async(a => a.File(
                path: System.IO.Path.Combine(logDirectory, "stockanalyzer-.log"),
                rollingInterval: RollingInterval.Day,
                retainedFileCountLimit: 30,
        ...
        catch (Exception ex)
        {
            ...
            System.IO.File.WriteAllText(System.IO.Path.Combine(AppContext.BaseDirectory, "launcher_error.log"), msg);
            throw;
        }
        finally
        {
