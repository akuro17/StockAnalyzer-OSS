...
public class PriceTypeToLabelConverter : IValueConverter
{
    public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
    {
        if (value is StockAnalyzer.Core.Models.PriceType pt)
        {
            return StockAnalyzer.Core.Models.Indicators.PriceDataHelper.FormatPriceTypeLabel(pt);
        }
