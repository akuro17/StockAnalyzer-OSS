...
public class DialogService : IDialogService
{
    ...
    public async Task<DrawingSettingsResult> ShowDrawingSettingsDialogAsync(StockAnalyzer.Avalonia.Drawing.IChartObject drawing, Action<StockAnalyzer.Avalonia.Drawing.IChartObject>? onApply = null)
    {
        if (Application.Current?.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
             return await global::Avalonia.Threading.Dispatcher.UIThread.InvokeAsync(async () =>
             {
                ...
                var dialog = new Views.Dialogs.DrawingSettingsDialog(drawing, registry, onApply);
