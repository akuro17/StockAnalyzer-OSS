...
public class DialogService : IDialogService
{
    ...
    public async Task<bool> ShowEditTickerNotesDialogAsync(string ticker, decimal? longVal = null, decimal? exitLong = null, decimal? stopLossLong = null, decimal? shortVal = null, decimal? exitShort = null, decimal? stopLossShort = null, string? notes = null, Action<decimal?, decimal?, decimal?, decimal?, decimal?, decimal?, string?>? onSave = null)
    {
        if (Application.Current?.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            return await global::Avalonia.Threading.Dispatcher.UIThread.InvokeAsync(async () =>
            {
                ...
                var vm = new StockAnalyzer.Avalonia.ViewModels.Dialogs.EditTickerNotesDialogViewModel(
                    ticker, longVal, exitLong, stopLossLong, shortVal, exitShort, stopLossShort, notes, onSave,
                ...
                {
                    onSave(vm.Long, vm.ExitLong, vm.StopLossLong, vm.Short, vm.ExitShort, vm.StopLossShort, vm.Notes);
                }
                return result;
            });
        }
    ...
    [System.Obsolete("Use the 6-parameter overload (longVal, exitLong, stopLossLong, shortVal, exitShort, stopLossShort, notes) instead.")]
    public async Task<bool> ShowEditTickerNotesDialogAsync(string ticker, decimal? entryPrice, decimal? targetPrice, decimal? stopLoss, string? notes, Action<decimal?, decimal?, decimal?, string?>? onSave)
    {
        return await ShowEditTickerNotesDialogAsync(ticker, entryPrice, targetPrice, stopLoss, null, null, null, notes,
