...
public class MockStockAnalyzerSettings : IStockAnalyzerSettings
{
    ...
    // Pattern Recognition
    public int PatternRecognitionMinWindow => StockAnalyzer.Core.ChartConstants.PatternRecognitionDefaultMinWindow;
    public int PatternRecognitionMaxWindow => StockAnalyzer.Core.ChartConstants.PatternRecognitionDefaultMaxWindow;
    public int PatternRecognitionWindowStep => StockAnalyzer.Core.ChartConstants.PatternRecognitionDefaultWindowStep;
    public double PatternRecognitionDefaultThreshold => StockAnalyzer.Core.ChartConstants.PatternRecognitionDefaultThreshold;
    ...
    public StockAnalyzer.Core.Models.Training.TargetType PredictionTargetType => StockAnalyzer.Core.Models.Training.TargetType.Classification;
    public StockAnalyzer.Core.Models.Training.FeatureSpec? PredictionFeatureSpec => null;
    public int PredictionMaxComposedChannels => 1024;
    public int PredictionMaxComposedTensorSizeMB => 256;
