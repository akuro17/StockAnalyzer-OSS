...
public class StockAnalyzerSettings : IStockAnalyzerSettings
{
    ...
    public StockAnalyzerSettings(
        ...
        IPredictionSettingsManager? predictionSettingsManager = null,
        ILogger<StockAnalyzerSettings>? logger = null,
        IOptions<StockAnalyzer.Core.Models.Settings.BacktestSettings>? backtestOptions = null,
        IOptions<StockAnalyzer.Core.Models.Settings.DrawingInteractionSettings>? drawingInteractionOptions = null,
        IOptions<StockAnalyzer.Core.Models.Settings.PythonIpcSettings>? pythonIpcOptions = null)
    {
        ...
        _pythonIpcSettings = pythonIpcOptions?.Value ?? new StockAnalyzer.Core.Models.Settings.PythonIpcSettings();
        _pythonIpcSettings.Validate();

        _backtestSettings = backtestOptions?.Value ?? new StockAnalyzer.Core.Models.Settings.BacktestSettings();
        _backtestSettings.Validate();

        _drawingInteractionSettings = drawingInteractionOptions?.Value ?? new StockAnalyzer.Core.Models.Settings.DrawingInteractionSettings();
        _drawingInteractionSettings.Validate();
    }
    ...
    private readonly StockAnalyzer.Core.Models.Settings.PythonIpcSettings _pythonIpcSettings;
    private readonly StockAnalyzer.Core.Models.Settings.BacktestSettings _backtestSettings;
    private readonly StockAnalyzer.Core.Models.Settings.DrawingInteractionSettings _drawingInteractionSettings;
    ...
    public int PythonRequestTimeoutMs => _pythonIpcSettings.RequestTimeoutMs;
    public int PythonMaxResponseBytes => _pythonIpcSettings.MaxResponseBytes;
    public int PythonMaxTimeoutRetries => _pythonIpcSettings.MaxTimeoutRetries;
    ...
    public StockAnalyzer.Core.Models.Settings.DrawingInteractionSettings DrawingInteraction => _drawingInteractionSettings;

    // Pattern Recognition
    public int BacktestMaxConditionOffset => _backtestSettings.MaxConditionOffset;
    ...
    public int PredictionWindowSize => _predictionSettingsManager != null && _predictionSettingsManager.WindowSize > 0 
        ? _predictionSettingsManager.WindowSize 
        : _predictionSettings.WindowSize;
    public PredictionFeatureMode PredictionFeatureMode => _predictionSettings.FeatureMode;
    public StockAnalyzer.Core.Models.Training.TargetType PredictionTargetType => _predictionSettings.TargetType;
    public StockAnalyzer.Core.Models.Training.FeatureSpec? PredictionFeatureSpec => _predictionSettings.FeatureSpec;
    public int PredictionMaxComposedChannels => _predictionSettings.MaxComposedChannels;
    public int PredictionMaxComposedTensorSizeMB => _predictionSettings.MaxComposedTensorSizeMB;
    public float PredictionConfidenceThreshold => _predictionSettings.ConfidenceThreshold;
    public string? PredictionInputNodeName => _predictionSettings.InputNodeName;
    public string? PredictionOutputNodeName => _predictionSettings.OutputNodeName;
    public IReadOnlyList<string> PredictionClassLabels => _predictionSettings.ClassLabels;
    public int PredictionRetryMaxAttempts => _predictionSettings.RetryMaxAttempts;
    public int PredictionRetryBaseDelayMs => _predictionSettings.RetryBaseDelayMs;
    public int PredictionRetryMaxDelayMs => _predictionSettings.RetryMaxDelayMs;
