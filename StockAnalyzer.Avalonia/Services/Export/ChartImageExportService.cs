...
/// </summary>
public sealed class ChartImageExportService : IChartImageExportService, ILayeredChartImageExportService
{
    ...
    public Task<byte[]> RenderChartImageAsync(
        ...
        => RenderImageCore(
            ...
            objectManager, mainRenderer, renderConfig, chartType, rulerRenderer, metadata, null);

    public Task<byte[]> RenderLayeredChartImageAsync(
        ChartDataSnapshot snapshot,
        ChartLayoutContext layout,
        ICoordinateTransform transform,
        ChartImageExportOptions options,
        ...
        => RenderImageCore(
            snapshot, layout, transform, options, themeManager,
            objectManager, mainRenderer, renderConfig, chartType, rulerRenderer, metadata, layeredScene);

    private Task<byte[]> RenderImageCore(
        ChartDataSnapshot snapshot,
        ChartLayoutContext layout,
        ICoordinateTransform transform,
        ChartImageExportOptions options,
    ...
    public Task<byte[]> RenderChartPreviewAsync(
        ...
        => RenderPreviewCore(
            snapshot, layout, transform, options, themeManager,
            objectManager, mainRenderer, renderConfig, chartType, rulerRenderer, metadata, null, previewMaxWidth);

    public Task<byte[]> RenderLayeredChartPreviewAsync(
        ChartDataSnapshot snapshot,
        ChartLayoutContext layout,
        ICoordinateTransform transform,
        ChartImageExportOptions options,
        ...
        => RenderPreviewCore(
            snapshot, layout, transform, options, themeManager,
            objectManager, mainRenderer, renderConfig, chartType, rulerRenderer, metadata, layeredScene, previewMaxWidth);

    private Task<byte[]> RenderPreviewCore(
        ChartDataSnapshot snapshot,
        ChartLayoutContext layout,
        ICoordinateTransform transform,
        ChartImageExportOptions options,
