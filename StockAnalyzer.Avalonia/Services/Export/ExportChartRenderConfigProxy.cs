    ...
    IComparisonRenderConfig
{
    ...
    public int MultiWavePatternMaxLines => _inner.MultiWavePatternMaxLines;
    public IndicatorColor? MultiWaveBullishColor => _inner.MultiWaveBullishColor;
    public IndicatorColor? MultiWaveBearishColor => _inner.MultiWaveBearishColor;
    ...
    // Dot
    public IndicatorColor DotUpColor => _inner is IDotChartRenderConfig c ? c.DotUpColor : _inner.BullishColor;
    public IndicatorColor DotDownColor => _inner is IDotChartRenderConfig c ? c.DotDownColor : _inner.BearishColor;
    public IndicatorColor DotNaturalColor => _inner is IDotChartRenderConfig c ? c.DotNaturalColor : _inner.NeutralColor;
    public double DotBaseRadius => _inner is IDotChartRenderConfig c ? c.DotBaseRadius : ChartSettingsConstants.DefaultDotBaseRadius;
    public DotShapeType DotShape => _inner is IDotChartRenderConfig c ? c.DotShape : DotShapeType.Circle;
    public PriceType DotPriceType => _inner is IDotChartRenderConfig c ? c.DotPriceType : PriceType.Close;
    ...
    public IndicatorColor PnfBreakoutBullishColor => _inner is IPnfRenderConfig c ? c.PnfBreakoutBullishColor : _inner.BullishColor;
    public IndicatorColor PnfBreakoutBearishColor => _inner is IPnfRenderConfig c ? c.PnfBreakoutBearishColor : _inner.BearishColor;
