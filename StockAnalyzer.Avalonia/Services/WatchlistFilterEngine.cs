...
namespace StockAnalyzer.Avalonia.Services
{
    public class WatchlistFilterEngine
    {
        ...
        public static bool TryGetDecimalValue(object value, out decimal result)
        {
            ...
            if (value is string s && decimal.TryParse(s, System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out var p)) { result = p; return true; }
            result = 0;
            return false;
        }
            ...
            else
            {
                ...
                if (val != null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (decimal.TryParse(rule.Value, System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out var filterDec))
                            {
