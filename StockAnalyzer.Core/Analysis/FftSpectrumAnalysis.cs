...
/// <summary>
/// Pure C# mathematical engine for Discrete Fourier Transform (DFT / FFT Spectrum) analysis.
/// Computes harmonic frequency bins, periods, magnitudes, and power distributions.
/// </summary>
public static class FftSpectrumAnalysis
{
    ...
    /// <summary>
    /// Computes the discrete Fourier transform spectrum over a sequence of real price values.
        ...
        double maxPeriod = double.MaxValue)
    {
        ...
        // 3. Discrete Fourier Transform for real signal: k = 1 to n / 2 (excluding DC component k=0)
        int halfN = n / 2;
        ...
        for (int k = 1; k <= halfN; k++)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                re += processed[i] * Math.Cos(angle);
                im -= processed[i] * Math.Sin(angle);
            }
