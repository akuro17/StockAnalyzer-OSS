...
/// exit order (Limit/Stop) and the maintenance-margin liquidation threshold both apply to the same
/// open position on the same bar, whichever is touched FIRST along the fixed
...
{
    /// <param name="pendingOrderPosition">Result of <see cref="FillPathScanner.TryFindTouchPosition"/> for the resting exit order, or null if it does not touch this bar.</param>
