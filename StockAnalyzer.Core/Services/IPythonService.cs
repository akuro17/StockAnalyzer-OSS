...
namespace StockAnalyzer.Core.Services
{
    ...
    public interface IPythonService
    {
        ...
        Task<string> SearchSimilarPatternsAsync(int lookback = 0, int topK = 5, int futureSteps = 20, double threshold = 0.3, int queryLength = 30, int queryStartIndex = -1, bool useStructural = false, int warpingRadius = IndicatorDefaultConstants.DtwDefaultWarpingRadius, System.Collections.Generic.IReadOnlyList<double>? volatility = null);
