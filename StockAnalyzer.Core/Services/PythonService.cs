...
namespace StockAnalyzer.Core.Services
{
    public class PythonService : IPythonService, IAsyncDisposable
    {
        ...
        public async Task<string> CalculateFftCycleAsync(int windowSize = ChartConstants.FftCycleDefaultWindowSize)
        {
            if (_processManager == null) throw new InvalidOperationException("External process not initialized.");
        ...
        public async Task<string> CalculateFourierTransformAsync(int targetPeriod = ChartConstants.FourierTransformDefaultTargetPeriod)
        {
            if (_processManager == null) throw new InvalidOperationException("External process not initialized.");
        ...
        public async Task<string> CalculateFftTrendFilterAsync(int windowSize = ChartConstants.FftTrendFilterDefaultWindowSize, int numHarmonics = ChartConstants.FftTrendFilterDefaultNumHarmonics)
        {
            if (_processManager == null) throw new InvalidOperationException("External process not initialized.");
