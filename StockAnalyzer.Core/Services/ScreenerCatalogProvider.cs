...
public class ScreenerCatalogProvider : IScreenerCatalogProvider
{
    ...
    public IReadOnlyList<string> GetOutputSeriesNames(IndicatorType type, IIndicatorFactory? indicatorFactory = null)
        => IndicatorOutputSeriesResolver.GetDisplayNames(type, indicatorFactory);

    public string NormalizeOutputSeriesName(
        IndicatorType type,
        string? outputName,
        PriceType? priceSource = null,
        IIndicatorFactory? indicatorFactory = null) =>
        IndicatorOutputSeriesResolver.Normalize(type, outputName, priceSource, indicatorFactory);
