...
public static class ChartConstants
{
    ...
    /// <summary>Initial chart symbol. Empty = no symbol until the user enters one.</summary>
    ...
    /// <summary>Default minimum window length (bars) of DTW chart-pattern detection (fallback of the PatternRecognition:MinWindow setting).</summary>
    public const int PatternRecognitionDefaultMinWindow = 20;

    /// <summary>Default maximum window length (bars) of DTW chart-pattern detection (fallback of the PatternRecognition:MaxWindow setting).</summary>
    public const int PatternRecognitionDefaultMaxWindow = 60;

    /// <summary>Default sliding-window step (bars) of DTW chart-pattern detection (fallback of the PatternRecognition:WindowStep setting).</summary>
    public const int PatternRecognitionDefaultWindowStep = 5;

    /// <summary>Default minimum similarity score of DTW chart-pattern detection (fallback of the PatternRecognition:DefaultThreshold setting).</summary>
    public const double PatternRecognitionDefaultThreshold = 0.5;
    ...
    // Logic Thresholds
    /// <summary>Extra bars reserved to the right of an indicator's future projection tip (e.g. the Ichimoku Kumo), on top of <c>GetFutureProjectionBars()</c>.</summary>
    public const int FutureProjectionBuffer = 5;
