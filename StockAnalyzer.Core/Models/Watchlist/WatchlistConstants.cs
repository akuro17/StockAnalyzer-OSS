...
public static class WatchlistConstants
{
    ...
    public const string FormatIndicatorDecimal = "N2";
    public const string FormatMicroDecimal = "N4";
    ...
    public const string WidthTag = "100";
    public const string WidthNotes = "150";
    public const string WidthDefault = "80";

    // Column Bounds
    public const double DefaultColumnMinWidth = 30.0;
    public const double DefaultColumnMaxWidth = 1000.0;

    // Tooltip Layout
    public const double TooltipContentMargin = 2.0;
}
