...
public class CoreMovingAverageCrossParameter : CoreIndicatorParameterBase
{
    ...
    /// <summary>
    /// Matches CoreMovingAverageCrossIndicator's CalculateSma warmup boundary (period - 1),
    /// using the larger of the two periods since Validate() does not enforce Short &lt; Long.
    /// </summary>
    public override int GetRequiredWarmupBars() => Math.Max(ShortPeriod, LongPeriod);
