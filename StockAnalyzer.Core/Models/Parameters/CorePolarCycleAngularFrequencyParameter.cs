...
/// <summary>
/// Parameters for <c>CorePolarCycleAngularFrequencyIndicator</c>.
/// The analytic-signal source parameters mirror the Hilbert Transform suite (Ehlers / IIR fixed, Q1).
/// The angular frequency is derived from the Homodyne-discriminator instantaneous period, so these
/// same period bounds directly shape the output range (omega in [2*pi/MaxPeriod, 2*pi/MinPeriod]).
/// </summary>
public class CorePolarCycleAngularFrequencyParameter : CoreIndicatorParameterBase
{
