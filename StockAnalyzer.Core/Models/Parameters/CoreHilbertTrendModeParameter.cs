...
public class CoreHilbertTrendModeParameter : CoreIndicatorParameterBase
{
    ...
    private int _stabilityWindow = 10;
    private double _stabilityThreshold = IndicatorDefaultConstants.HilbertTrendModeDefaultStabilityThreshold;
    ...
    [CoreParameterRange(2, 50)]
    [Range(2, 50)]
    [DisplayName("Stability Window")]
    [Description("Rolling sample count for evaluating cycle stability via standard deviation of phase delta.")]
    public int StabilityWindow
    {
        get => _stabilityWindow;
        set => SetProperty(ref _stabilityWindow, value);
    }

    [CoreParameterRange(1.0, 45.0)]
    [Range(1.0, 45.0)]
    [DisplayName("Stability Threshold")]
    [Description("Phase delta standard deviation threshold in degrees to identify trend mode vs cycle mode.")]
    public double StabilityThreshold
    {
        get => _stabilityThreshold;
        set => SetProperty(ref _stabilityThreshold, value);
    }
    ...
    public override void Validate()
    {
        ...
        if (StabilityThreshold <= 0.0 || StabilityThreshold > 90.0)
            throw new ArgumentOutOfRangeException(nameof(StabilityThreshold), "StabilityThreshold must be in (0, 90].");
    }
}
