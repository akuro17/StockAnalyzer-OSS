...
public class ScreenerIndicatorGroup
{
    ...
    public static IReadOnlyList<ScreenerIndicatorGroup> GetDefaultGroups()
    {
        return new List<ScreenerIndicatorGroup>
        {
            ...
            new("Price", new[] { IndicatorType.Price }, "Indicator", "ScreenerGroup_Price"),
            new("Trend", new[]
            {
                ...
                IndicatorType.FFTTrendFilter, IndicatorType.VIDYA
            ...
            new("Oscillator", new[]
            {
                ...
                IndicatorType.StructuralDtw, IndicatorType.FrechetOscillator
            ...
            new("Math", new[]
            {
                ...
                IndicatorType.IFFTInstantaneousPhase, IndicatorType.IFFTInstantaneousAmplitude,
                IndicatorType.IFFTBandPassFilter, IndicatorType.PolarAmplitudeRatio,
                IndicatorType.PolarPhase, IndicatorType.PolarCycleAngularFrequency,
                ...
                IndicatorType.HiddenMarkovModel, IndicatorType.ARIMA
