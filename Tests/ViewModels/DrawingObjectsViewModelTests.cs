...
public class DrawingObjectsViewModelTests
{
    ...
    private class FakeDialogService : IDialogService
    {
        ...
        public Task<DrawingSettingsResult> ShowDrawingSettingsDialogAsync(IChartObject drawing, Action<IChartObject>? onApply = null, StockAnalyzer.Avalonia.Services.Drawing.IDrawingEditCoordinator? coordinator = null, IReadOnlyList<StockAnalyzer.Core.Models.CoreCandleData>? candles = null) => throw new NotImplementedException();
        ...
        public Task ShowSourceIndicatorRegistrationDialogAsync() => Task.CompletedTask;
        public Task ShowDynamicPeriodDriverRegistrationDialogAsync() => Task.CompletedTask;
    ...
    [Fact]
    public void UndoRedo_WithoutChartViewModel_CanExecuteIsFalse()
    {
        var dispatcher = new SynchronousDispatcherService();
        var manager = new ChartObjectManager();
