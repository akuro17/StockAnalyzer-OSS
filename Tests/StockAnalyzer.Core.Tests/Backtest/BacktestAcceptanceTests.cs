...
public class BacktestAcceptanceTests
{
    ...
    public void GoldenLong_E1000_3Bars_NetPnL10()
    {
        ...
        BacktestResult result = VerificationHarness.CreateEngine().Run(MakeInput(bars), config, strategy);
    ...
    public void MOC_vs_MOO_SameSignal_DifferentFillPrice()
    {
        ...
        BacktestResult mooResult = VerificationHarness.CreateEngine().Run(
        ...
        BacktestResult mocResult = VerificationHarness.CreateEngine().Run(
            MakeInput(bars), config,
    ...
    public void GTD_ExpiryBar_FillOnExpiryDay_ThenExpireNext()
    {
        ...
        BacktestResult filled = VerificationHarness.CreateEngine().Run(MakeInput(fillingBars), config, fillingStrategy);
        ...
        BacktestResult expired = VerificationHarness.CreateEngine().Run(MakeInput(expiringBars), config, expiringStrategy);
    ...
    public void SingleBar_NoTrade_EquityEquals_E0()
    {
        ...
        BacktestResult result = VerificationHarness.CreateEngine().Run(MakeInput(bars), config, new ScriptedStrategy(new Dictionary<int, StrategyOrderRequest>()));
    ...
    public void MOC_LimitPriceNonNull_InputError()
    {
        ...
        Assert.Throws<ArgumentException>(() => VerificationHarness.CreateEngine().Run(MakeInput(bars), config, strategy));
    }
