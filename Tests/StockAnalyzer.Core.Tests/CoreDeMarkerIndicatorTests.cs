...
{
    public class CoreDeMarkerIndicatorTests
    {
        private readonly List<CoreCandleData> _testData;

        public CoreDeMarkerIndicatorTests()
        {
        ...
        {
            var indicator = new CoreDeMarkerIndicator { Period = 14 };
        ...
        {
            var indicator = new CoreDeMarkerIndicator();
        ...
        {
            var indicator = new CoreDeMarkerIndicator { Period = 14 };
            var insufficientData = _testData.Take(10).ToList();
