...
namespace StockAnalyzer.Core.Tests
{
    public class CoreElderRayIndicatorTests
    {
        ...
        {
            var closeBased = new CoreElderRayIndicator { Period = 13, PriceSource = PriceType.Close };
            var openBased = new CoreElderRayIndicator { Period = 13, PriceSource = PriceType.Open };
