...
public class AdaptiveSmoothingHelperTests
{
    ...
    [Fact]
    public void IsPeriodNativeDriverType_IdentifiesNativeTypesCorrectly()
    {
        Assert.True(AdaptiveSmoothingHelper.IsPeriodNativeDriverType(IndicatorType.HilbertTransform));
        Assert.True(AdaptiveSmoothingHelper.IsPeriodNativeDriverType(IndicatorType.FFTCycle));
        Assert.True(AdaptiveSmoothingHelper.IsPeriodNativeDriverType(IndicatorType.Autocorrelation));

        Assert.False(AdaptiveSmoothingHelper.IsPeriodNativeDriverType(IndicatorType.SMA));
        Assert.False(AdaptiveSmoothingHelper.IsPeriodNativeDriverType(IndicatorType.RSI));
        Assert.False(AdaptiveSmoothingHelper.IsPeriodNativeDriverType(null));
    }
}
