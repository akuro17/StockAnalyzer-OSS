...
public class NoteEditorViewModelTests
{
        ...
        string tempDir, IMarketDataProvider? marketDataProvider = null)
    {
        ...
        var editor = new NoteEditorViewModel(noteRepository, attachmentRepository, cacheSynchronizer, marketDataProvider ?? new FakeMarketDataProvider(), new FakeDispatcherService(), NullLogger<NoteEditorViewModel>.Instance);
