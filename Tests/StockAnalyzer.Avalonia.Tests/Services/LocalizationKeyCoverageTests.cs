...
/// Scope: keys referenced from <c>*.axaml</c> via the <c>l:Localize</c> markup extension. Keys looked up
/// only from code (<c>LocalizationManager.Instance["..."]</c>) are not covered here.
/// </summary>
