...
/// StockAnalyzer.Avalonia.Tests.Services.SynchronousDispatcherService instead.
/// </summary>
public class FakeDialogService : IDialogService
{
    ...
    public Task<DrawingSettingsResult> ShowDrawingSettingsDialogAsync(IChartObject drawing) => throw new NotImplementedException();
...
public static class NoteTimelineTestFixture
{
        ...
        INotesSettingsManager? notesSettingsManager = null)
    {
        ...
        NoteEditorViewModel EditorFactory() => new(noteRepository, attachmentRepository, cacheSynchronizer, resolvedMarketDataProvider, resolvedDispatcherService, NullLogger<NoteEditorViewModel>.Instance);
