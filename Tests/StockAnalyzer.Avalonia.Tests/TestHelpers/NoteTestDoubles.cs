...
public class FakeDialogService : IDialogService
{
    ...
    public Task<DrawingSettingsResult> ShowDrawingSettingsDialogAsync(IChartObject drawing, Action<IChartObject>? onApply = null, StockAnalyzer.Avalonia.Services.Drawing.IDrawingEditCoordinator? coordinator = null, IReadOnlyList<CoreCandleData>? candles = null) => throw new NotImplementedException();
