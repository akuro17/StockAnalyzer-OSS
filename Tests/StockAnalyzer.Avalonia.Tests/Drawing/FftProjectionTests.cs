...
public class FftProjectionTests
{
    ...
    [Fact]
    public void FftProjectionObject_InitialPlacement_Defaults()
    {
        var obj = new FftProjectionObject();

        Assert.Equal(ChartObjectType.FftProjection, obj.Type);
        ...
        Assert.Equal(3, obj.HarmonicCount);
        Assert.True(obj.ApplyDetrend);
        Assert.Equal(3.0, obj.MinPeriod);
    ...
    [Fact]
    public void FftProjectionObject_Recalculate_CalculatesProjectedPath_And_ConfidenceBands()
    {
        ...
        // Select candles from index 0 to 14
    ...
    [Fact]
    public void FftProjectionObject_Recalculate_WithEmptyCandles_ClearsPath()
    {
        var obj = new FftProjectionObject();
    ...
    [Fact]
    public void FftProjectionObject_Translate_UpdatesPointsAndProjectedPath()
    {
        var candles = MakeSampleCandles(10, startPrice: 50m, step: 1m);
        var obj = new FftProjectionObject();
        obj.Points.Add(new ChartPoint(candles[0].Timestamp, candles[0].Close));
    ...
    [Fact]
    public void FftProjectionObject_VerticalRange_HitTest_CoversFullHeight()
    {
        var t = MakeTransform();
