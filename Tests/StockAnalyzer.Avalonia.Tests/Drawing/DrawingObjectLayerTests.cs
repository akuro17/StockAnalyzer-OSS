...
public class DrawingObjectLayerTests
{
    ...
    [Fact]
    public void ChartObjectManager_GetObjectAt_ShouldRespectVisibilityAndLock()
    {
        var manager = new ChartObjectManager();
        var invisibleObj = new MockChartObject { IsVisible = false };
    ...
    [Fact]
    public void SelectionSoundness_Invariant_I03()
    {
        var manager = new ChartObjectManager();
