...
public class DrawingDocumentCodecTests
{
    ...
    [Fact]
    public void CaptureAndMaterialize_FftProjectionObject()
    {
        var manager = new ChartObjectManager();
        ...
        fft.Points.Add(new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m));
        manager.AddObject(fft);
        var key = new DrawingDocumentKey("7203", TimeframeType.Daily);
        var state = DrawingDocumentCodec.Capture(manager, key, 1);
        using var mat = DrawingDocumentCodec.Materialize(state);
    }

    [Fact]
    public void CaptureAndMaterialize_DtwProjectionObject()
    {
        var manager = new ChartObjectManager();
        ...
        dtw.Points.Add(new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m));
        dtw.ProjectedPath.Add(new StockAnalyzer.Core.Models.Point(123456789, 105.0));
    ...
    [Fact]
    public void CaptureAndMaterialize_KalmanFilterProjectionObject()
    {
        var manager = new ChartObjectManager();
        var p1 = new ChartPoint(new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc), 100m);
        var p2 = new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m);
        var obj = new StockAnalyzer.Avalonia.Drawing.Objects.KalmanFilterProjectionObject();
        obj.Points.Add(p1); obj.Points.Add(p2);
    ...
    [Fact]
    public void CaptureAndMaterialize_ArimaProjectionObject()
    {
        var manager = new ChartObjectManager();
        var p1 = new ChartPoint(new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc), 100m);
        var p2 = new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m);
        var obj = new StockAnalyzer.Avalonia.Drawing.Objects.ArimaProjectionObject();
        obj.Points.Add(p1); obj.Points.Add(p2);
        manager.AddObject(obj);
        var key = new DrawingDocumentKey("7203", TimeframeType.Daily);
        var state = DrawingDocumentCodec.Capture(manager, key, 1);
    ...
    [Fact]
    public void CaptureAndMaterialize_HmmProjectionObject()
    {
        var manager = new ChartObjectManager();
        var p1 = new ChartPoint(new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc), 100m);
        var p2 = new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m);
        var obj = new StockAnalyzer.Avalonia.Drawing.Objects.HmmProjectionObject();
        obj.Points.Add(p1); obj.Points.Add(p2);
        manager.AddObject(obj);
        var key = new DrawingDocumentKey("7203", TimeframeType.Daily);
        var state = DrawingDocumentCodec.Capture(manager, key, 1);
    ...
    [Fact]
    public void CaptureAndMaterialize_PearsonProjectionObject()
    {
        var manager = new ChartObjectManager();
        var p1 = new ChartPoint(new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc), 100m);
        var p2 = new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m);
        var obj = new StockAnalyzer.Avalonia.Drawing.Objects.PearsonProjectionObject();
        obj.Points.Add(p1); obj.Points.Add(p2);
        manager.AddObject(obj);
        var key = new DrawingDocumentKey("7203", TimeframeType.Daily);
        var state = DrawingDocumentCodec.Capture(manager, key, 1);
    ...
    [Fact]
    public void CaptureAndMaterialize_FrechetProjectionObject()
    {
        var manager = new ChartObjectManager();
        var p1 = new ChartPoint(new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc), 100m);
        var p2 = new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m);
        var obj = new StockAnalyzer.Avalonia.Drawing.Objects.FrechetProjectionObject();
        obj.Points.Add(p1); obj.Points.Add(p2);
        manager.AddObject(obj);
        var key = new DrawingDocumentKey("7203", TimeframeType.Daily);
        var state = DrawingDocumentCodec.Capture(manager, key, 1);
    ...
    [Fact]
    public void CaptureAndMaterialize_SsaProjectionObject()
    {
        var manager = new ChartObjectManager();
        var p1 = new ChartPoint(new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc), 100m);
        var p2 = new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m);
        var obj = new StockAnalyzer.Avalonia.Drawing.Objects.SsaProjectionObject();
        obj.Points.Add(p1); obj.Points.Add(p2);
        manager.AddObject(obj);
        var key = new DrawingDocumentKey("7203", TimeframeType.Daily);
        var state = DrawingDocumentCodec.Capture(manager, key, 1);
    ...
    [Fact]
    public void CaptureAndMaterialize_SsaMultiComponentObject()
    {
        var manager = new ChartObjectManager();
        var p1 = new ChartPoint(new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc), 100m);
        var p2 = new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m);
        var obj = new StockAnalyzer.Avalonia.Drawing.Objects.SsaMultiComponentObject();
        obj.Points.Add(p1); obj.Points.Add(p2);
        manager.AddObject(obj);
        var key = new DrawingDocumentKey("7203", TimeframeType.Daily);
        var state = DrawingDocumentCodec.Capture(manager, key, 1);
    ...
    [Fact]
    public void CaptureAndMaterialize_HarmonicPatternObject()
    {
        var manager = new ChartObjectManager();
        var p1 = new ChartPoint(new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc), 100m);
        var p2 = new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m);
        var obj = new StockAnalyzer.Avalonia.Drawing.Objects.HarmonicPatternObject();
        obj.Points.Add(p1); obj.Points.Add(p2);
        manager.AddObject(obj);
        var key = new DrawingDocumentKey("7203", TimeframeType.Daily);
        var state = DrawingDocumentCodec.Capture(manager, key, 1);
    ...
    [Fact]
    public void CaptureAndMaterialize_AutoElliottWaveObject()
    {
        var manager = new ChartObjectManager();
        var p1 = new ChartPoint(new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc), 100m);
        var p2 = new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m);
        var obj = new StockAnalyzer.Avalonia.Drawing.Objects.AutoElliottWaveObject();
        obj.Points.Add(p1); obj.Points.Add(p2);
        manager.AddObject(obj);
        var key = new DrawingDocumentKey("7203", TimeframeType.Daily);
        var state = DrawingDocumentCodec.Capture(manager, key, 1);
    ...
    [Fact]
    public void CaptureAndMaterialize_MultiProjectionObjectsTogether()
    {
        var manager = new ChartObjectManager();
        var p1 = new ChartPoint(new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc), 100m);
        var p2 = new ChartPoint(new DateTime(2024, 1, 10, 0, 0, 0, DateTimeKind.Utc), 110m);
        ...
        var dtw = new StockAnalyzer.Avalonia.Drawing.Objects.DtwProjectionObject();
        dtw.Points.Add(p1); dtw.Points.Add(p2);
        dtw.ProjectedPath.Add(new StockAnalyzer.Core.Models.Point(100, 105.0));
        manager.AddObject(dtw);

        var fft = new StockAnalyzer.Avalonia.Drawing.Objects.FftProjectionObject();
        fft.Points.Add(p1); fft.Points.Add(p2);
        manager.AddObject(fft);

        var hmm = new StockAnalyzer.Avalonia.Drawing.Objects.HmmProjectionObject();
        hmm.Points.Add(p1); hmm.Points.Add(p2);
        ...
        Assert.Equal(3, mat.Objects[ChartDrawingContextType.Standard].Count);
    }
}
