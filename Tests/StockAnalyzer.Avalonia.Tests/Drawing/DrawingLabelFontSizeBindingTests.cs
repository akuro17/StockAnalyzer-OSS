...
public class DrawingLabelFontSizeBindingTests
{
    ...
    public void PolylineObject_DefaultFontSize_MatchesDrawingThemeContext()
    {
        ...
        // PolylineObject.FontSize defaults to the dedicated drawing font size (Settings > Chart), not the
        // Detail font size; the two only coincided while both defaulted to 12.
