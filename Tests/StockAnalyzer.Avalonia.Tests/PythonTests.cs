...
namespace StockAnalyzer.Avalonia.Tests
{
    public class PythonTests
    {
        ...
        private class CustomPythonSettings : IStockAnalyzerSettings
        {
            ...
            public StockAnalyzer.Core.Models.PredictionFeatureMode PredictionFeatureMode => _base.PredictionFeatureMode;
            public float PredictionConfidenceThreshold => _base.PredictionConfidenceThreshold;
            public string? PredictionInputNodeName => _base.PredictionInputNodeName;
            public string? PredictionOutputNodeName => _base.PredictionOutputNodeName;
            public System.Collections.Generic.IReadOnlyList<string> PredictionClassLabels => _base.PredictionClassLabels;
            public int PredictionRetryMaxAttempts => _base.PredictionRetryMaxAttempts;
            public int PredictionRetryBaseDelayMs => _base.PredictionRetryBaseDelayMs;
            public int PredictionRetryMaxDelayMs => _base.PredictionRetryMaxDelayMs;
